...
--
-- Name: ir_act_server_mail_channel_rel; Type: TABLE; Schema: public; Owner: odoo
--
...
ALTER TABLE public.ir_act_server_mail_channel_rel OWNER TO odoo;

--
-- Name: TABLE ir_act_server_mail_channel_rel; Type: COMMENT; Schema: public; Owner: odoo
--
...
--
-- Name: ir_act_server_mail_channel_rel ir_act_server_mail_channel_re_ir_act_server_id_mail_channel_key; Type: CONSTRAINT; Schema: public; Owner: odoo
--
...
--
-- Name: ir_act_server_mail_channel_rel_ir_act_server_id_idx; Type: INDEX; Schema: public; Owner: odoo
--
...
--
-- Name: ir_act_server_mail_channel_rel_mail_channel_id_idx; Type: INDEX; Schema: public; Owner: odoo
--
...
--
-- Name: ir_act_server_mail_channel_rel ir_act_server_mail_channel_rel_ir_act_server_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: odoo
--
...
--
-- Name: ir_act_server_mail_channel_rel ir_act_server_mail_channel_rel_mail_channel_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: odoo
--
